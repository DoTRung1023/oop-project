...
debug: main.cpp AfricanElephant.cpp Animal.cpp BullDog.cpp Cactus.cpp Character.cpp Fortress.cpp GameProperty.cpp IndianElephant.cpp Mickey.cpp Player.cpp Poodle.cpp Rat.cpp Shepherd.cpp Sodier.cpp GameMove.cpp
